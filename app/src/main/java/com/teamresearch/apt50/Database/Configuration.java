...
public class Configuration {
    ...
    public Date getActivation_date()                         { return this.activation_date;}
    public void setActivation_date(Date activation_date)     { this.activation_date=activation_date;}
    public int getId()                                       { return this.id;}
    public void setId(int id)                                { this.id=id;}
    public long  getDevice_id()                               { return this.device_id;}
    public void setDevice_id(long device_id)                  { this.device_id=device_id;}
    ...
    public String getTrans_key()                             { return this.trans_key;}
    public void setTrans_key(String trans_key)               { this.trans_key=trans_key;}
}
